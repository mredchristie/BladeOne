              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
					...
					<?php
					$querey = mysqli_query($conn, 'SELECT * FROM registered_learners WHERE LearnerUsername like "%'. $_SESSION['name'] . '%"');
					$row = mysqli_fetch_array($querey);
					$id = $row["LearnerID"];
					print($row['LearnerUsername']);
					?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
					<?php
					  $querey = mysqli_query($conn, 'SELECT LearnerFullname FROM registered_learners WHERE LearnerID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['LearnerFullname']);
					  ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
					<?php
					  $querey = mysqli_query($conn, 'SELECT LearnerDateOfBirth FROM registered_learners WHERE LearnerID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['LearnerDateOfBirth']);
					  ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
					<?php
					  $querey = mysqli_query($conn, 'SELECT LearnerGender FROM registered_learners WHERE LearnerID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['LearnerGender']);
					  ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php
					  $querey = mysqli_query($conn, 'SELECT LearnerEmail FROM registered_learners WHERE LearnerID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['LearnerEmail']);
					  ?>
                    </div>
                  </div>
                  <hr>
				  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php
					  $querey = mysqli_query($conn, 'SELECT LearnerPhoneNumber FROM registered_learners WHERE LearnerID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['LearnerPhoneNumber']);
					  ?>
                    </div>
                  </div>
                  <hr>
				  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php
					  $querey = mysqli_query($conn, 'SELECT LearnerPassword FROM registered_learners WHERE LearnerID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['LearnerPassword']);
					  ?>
                    </div>
                  </div>
                  <hr>
