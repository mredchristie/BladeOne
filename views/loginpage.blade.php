        ...
        <form>
            <h2 class="text-center mb-3">Select an account</h2>
              <form>
                ...
                <a href="loginpagelearner.php" type="button" class="btn btn-secondary btn-block btn-lg text-body">Learner</a>
                </div>
                <div class="d-flex justify-content-center">
                <a href="loginpagetutor.php" type="button" class="btn btn-secondary btn-block btn-lg text-body">Tutor</a>
                </div>
