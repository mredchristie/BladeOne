              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
					<?php
					  $querey = mysqli_query($conn, 'SELECT TutorFullname FROM registered_tutors WHERE TutorID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['TutorFullname']);
					  ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
					<?php
					  $querey = mysqli_query($conn, 'SELECT TutorDateOfBirth FROM registered_tutors WHERE TutorID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['TutorDateOfBirth']);
					  ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
					<?php
					  $querey = mysqli_query($conn, 'SELECT TutorGender FROM registered_tutors WHERE TutorID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['TutorGender']);
					  ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php
					  $querey = mysqli_query($conn, 'SELECT TutorEmail FROM registered_tutors WHERE TutorID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['TutorEmail']);
					  ?>
                    </div>
                  </div>
                  <hr>
				  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php
					  $querey = mysqli_query($conn, 'SELECT TutorPhoneNumber FROM registered_tutors WHERE TutorID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['TutorPhoneNumber']);
					  ?>
                    </div>
                  </div>
                  <hr>
				  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php
					  $querey = mysqli_query($conn, 'SELECT TutorPassword FROM registered_tutors WHERE TutorID like "%'. $id . '%"');
					  $row = mysqli_fetch_array($querey);
					  print($row['TutorPassword']);
					  ?>
                    </div>
                  </div>
                  <hr>
