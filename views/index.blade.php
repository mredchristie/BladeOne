...
<div class="container my-4">
    <div class="row text-center">
      <div class="col-md-6 mb-4">
        ...
        <img class="rounded-circle " alt="100x100" src="tutoringimage.png"
          data-holder-rendered="true">
      </div>
      <div class="col-md-6 mb-4">

        <h2 class="my-5 h2"><p class="text-right">Welcome to GibJohn Tutoring - The digital tutoring solution for all age ranges and individuals seeking thorough learning.</p></h2>
<hr/>
        <h2 class="my-5 h2"><p class="text-right">Education availble in the form of digital tutoring and interactive questions and quizzes. There are also quizes and informative feedback!</p></h2>

<hr/>
        <h2 class="my-5 h2"><p class="text-right">We hope you enjoy using our platform!</p></h2>
      </div>
    </div>
  </div>
